...
if (session.getAttribute("reservation") != null) {
	reservation = session.getAttribute("reservation").toString();
}
%>
<!DOCTYPE html>
<html lang="en">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="http://localhost:8081/project_jee/auth.jsp">signin</a></li>
						<li class="nav-item"><a class="nav-link"
							href="http://localhost:8081/project_jee/auth2.jsp">Login</a></li>
						<%
						} else {
						String nom = "";
		...
		<div class="container">
			...
			<div class="row">
				<table class="table table-hover">
					...
					<tbody>
						<%
						data = " SELECT * FROM booking where user_id=?";
						PreparedStatement pst = conn.prepareStatement(data);
						
						pst.setString(1, session.getAttribute("user_id").toString());
						...
						<tr>
							...
							<th><%=res.getString("id")%></th>
							<td><%=res.getString("time")%></td>
							<td><%=res.getString("numero_client")%></td>
							<td><div class="col-md-12">

									<a class="status disabled"
										href="../annuler?id=<%=res.getString("id")%>">Annuler</a></td>
						</tr>
						<%
						}
						%>
