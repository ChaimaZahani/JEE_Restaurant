	...
	<div class="app-container">
		<div class="sidebar">
			...
			<ul class="sidebar-list">
				...
				<li class="sidebar-list-item"><a href="admin_gallery.jsp">
				...
				<li class="sidebar-list-item active"><a href="admin_avis.jsp">
						<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
							viewBox="0 0 24 24" fill="none" stroke="currentColor"
							stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
							class="feather feather-bell">
		...
		<div class="app-content">
			<div class="app-content-header">
				<h1 class="app-content-headerText">comments</h1>
			...
			<div class="products-area-wrapper tableView">
				<div class="products-header">
					<div class="product-cell image">Nom</div>
					<div class="product-cell category">commentaire</div>
				...
				<div class="products-row">
					...
					<div class="product-cell image">
						<span class="cell-label">nom:</span><%=res.getString("nom_complet").toString()%>
					</div>

					<div class="product-cell category">
						<span class="cell-label">commentaire:</span><%=res.getString("avis").toString()%>
					</div>
					<div class="product-cell price">
						<a class="status active"
							href="../delete_avis?id=<%=res.getString(1)%>">delete</a>
					</div>
				</div>
				<%
				}
