	...
	<div class="app-container">
		<div class="sidebar">
			...
			<ul class="sidebar-list">
				...
				<li class="sidebar-list-item "><a href="admin.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" width="18" height="18"
							viewBox="0 0 24 24" fill="none" stroke="currentColor"
							stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
				...
				<li class="sidebar-list-item active"><a href="admin_table.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" width="18" height="18"
							viewBox="0 0 24 24" fill="none" stroke="currentColor"
							stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
		...
		<div class="app-content">
			<div class="app-content-header">
				...
				<input type="submit" class="app-content-headerButton"  value="add table">
				</form>
			</div>
			...
			<div class="products-area-wrapper tableView">
				...
				<div class="products-row">
					...
					<div class="product-cell image">
						<span class="cell-label">Table:</span><%=res.getString("num_table").toString() %>
					</div>
					<div class="product-cell sales">
						<span class="cell-label">Dispo:</span>
						<% if(res.getInt("dispo")==1){
							%>
							<a class="status active" >available</a>
							<%
							}else{%>
						<a href="../available?id=<%=res.getString(1)%>" class="status disabled" > Non available</a>
						<%} %>
					</div>
					
					<div class="product-cell price">
						<a class="status disabled"  href="../delete_table?id=<%=res.getString(1)%>">delete</a>
					</div>
				</div>	
				<%} %>
			</div>
