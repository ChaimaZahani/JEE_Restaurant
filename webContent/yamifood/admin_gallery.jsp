	...
	<div class="app-container">
		<div class="sidebar">
			...
			<ul class="sidebar-list">
				...
				<li class="sidebar-list-item active"><a href="admin_gallery.jsp"> <svg
							xmlns="http://www.w3.org/2000/svg" width="18" height="18"
							viewBox="0 0 24 24" fill="none" stroke="currentColor"
							stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
		...
		<div class="app-content">
			<div class="app-content-header">
				<h1 class="app-content-headerText">pictures</h1>
				
				<form action="addImage.html" method="post">
				<input type="submit" class="app-content-headerButton"  value="add picture">
				</form>
			</div>
			...
			<div class="products-area-wrapper tableView">
				...
				<div class="products-row">
					...
					<div>
					<br>
						<a class="status active" href="../del?id=<%=res.getString(1)%>">delete</a>
					</div>
					<h1>&emsp;</h1>
