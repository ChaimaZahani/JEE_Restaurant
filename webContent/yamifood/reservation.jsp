			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form action="http://localhost:8081/project_jee/registration"
							method="POST">
							<div class="row">

								<div class="col-md-6">
									<%
									data = " SELECT count(*) FROM tables where dispo=1";
									res = stat.executeQuery(data);
									while (res.next()) {
									%>

									<h3>
										number of tables dispo:
										<%=res.getString(1)%></h3>
						...
						<form action="mes_reservation.jsp" method="POST">
		<div class="col-md-12">
			<div class="submit-button text-center">
				<button class="btn btn-common" id="submit" type="submit">Mes Reservation</button>
