...
<body>
	...
	<div class="menu-box">
		<div class="container">
			...
			<%
			data = " SELECT * FROM menu WHERE type='drinks'";
			...
			<div class="row special-list">
				<div class="col-lg-4 col-md-6 special-grid drinks">
					<div class="gallery-single fix">
						...
						<img src="images/<%=res.getString("image")%>" class="img-fluid"
							alt="Image" style="height:250px">
						<div class="why-text">
							<h4><%=res.getString("meal")%></h4>
							<p><%=res.getString("description")%></p>
							<h5><%=res.getString("prix")%></h5>
						</div>
					</div>
				</div>
				<%
				...
				<%
				data = " SELECT * FROM menu WHERE type='lunch'";
				res = stat.executeQuery(data);
				while (res.next()) {
				%>
				...
				%>
				<%
				data = " SELECT * FROM menu WHERE type='dinner'";
				res = stat.executeQuery(data);
				while (res.next()) {
				%>
